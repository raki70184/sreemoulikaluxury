  ...
  return (
    ...
    >
      ...
      {isAbout ? (
        ...
        <Grid item xs>
          <Typography variant="h6" align="justify" letterSpacing={0}>
            At SM, we are dedicated to bringing indulgence, comfort, and luxury
            right to your fingertips. From our contemporary ambiance to our
            extensive range of services, products, and color options, take a
            seat, and you might just find yourself wanting to stay all day.
          </Typography>
        </Grid>
      )}
    </Grid>
