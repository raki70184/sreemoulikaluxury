...
export const Footer = () => {
    ...
    return (<>
        <Grid container alignItems={"center"} spacing={3} justifyContent={"center"}>
            ...
            <Grid item container margin={2} alignItems={"center"} justifyContent={"center"}>
                <Hidden smDown><Grid item marginLeft={2}>Our Premium Brands</Grid></Hidden>
                <Grid item marginLeft={sm?0:4}><img src={davins} width='150px' /></Grid>
                <Grid item marginLeft={sm?2:4}><img src={voesh} width='200px'/></Grid>
            <Grid item textAlign={"right"} marginLeft={sm?0:4}>
